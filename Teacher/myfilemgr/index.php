...
<!--ajouter fichier de cours dans la table 'cours' de la base-->
<?php
...
$query=$conn->query("INSERT INTO cours (nom,date) VALUES ('$nom','$date')");
if($query){
...
<!---------------->
			...
			<tr style="width:500px;"><td><form enctype="multipart/form-data"  action="" id="wb_Form1" name="form" method="post">
				...
				<th>Remove</th>
                            ...
                            <tbody>
							<?php 
							//recuperer les donnes mn la table w nhotaha dans une tableau dynamqiue
							$query=mysqli_query($conn,"select * from cours ORDER BY id DESC")or die(mysqli_error($conn));
