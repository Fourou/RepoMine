...
$stmt = $con->prepare('SELECT motpasse, email FROM enseignant WHERE id = ?');
...
<div class="vert" style="margin-left:0px;">
        ...
        <div class="vertical-menu">
            ...
            <a href="proT.php"  class="active"><i class="fa fa-user-circle-o" style="font-size:20px"> &nbsp;Profil</i></a>
            <br><br>
                ...
                <div class="profile">
                    ...
                    <form action="/action_page.php" style="border:none;">
                        <div class="name">
                            ...
                            <input type="text" id="fname" name="fname" value="Mm.a" style="height:10px;border:none;margin-left:20px;"><br>
                        </div>
                        <br>
                        <div class="name">
